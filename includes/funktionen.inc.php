<?php
    ...
    function hole_eintraege()
    {
        ...
        $query = "SELECT artikel.bezeichnung, artikel.beschreibung, artikel.preis, zustand.zustand FROM artikel JOIN person ON person.email = artikel.person_email JOIN zustand ON zustand.artikel_id = artikel.id";
